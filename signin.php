...
?>
    ...
    <form action="" method="post">
		...
		<div class="form-group">
			...
			<div class="form-group">
            <button type="submit" name="signupbtn" class="btn btn-primary btn-lg">Sign in</button>
			
        </div>
		<div class="text-center">Dont't have an account? <a href="signup.php">Signup here</a></div>
                        </div>
                        <!-- end banner-cell -->
                    </div>
                    <!-- end banner-text -->
