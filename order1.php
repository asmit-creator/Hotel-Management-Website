                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="active"><a href="order1.php"><span class="glyphicon glyphicon-cutlery"></span> Food List</a></li>
...
<form method="post" action="chckout.php?action=add&id=<?php echo $row["F_ID"]; ?>">
 <div class="product-image4">
                    <a href="#">
                        <img class="pic-1" src="<?php echo $row["images_path"]; ?>" class="img-responsive">
                        <img class="pic-2" src="<?php echo $row["images_path"]; ?>" class="img-responsive">
                    </a>
                    <ul class="social">
