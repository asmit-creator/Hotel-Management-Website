                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="active"><a href="book.php"><span class="glyphicon glyphicon-pencil"></span> Bookings</a></li>
...
<section id="team" class="pb-5">
   ...
   <h2 class="block-title text-center">
					we provide booking for all type of functions
					</h2>
	
        <h5 class="section-title h1">have a eye!</h5>
        <div class="row">
            <!-- Team member -->
